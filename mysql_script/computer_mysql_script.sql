/*
 The Product table contains data on the
 maker, model number, and type of product ('PC', 'Laptop', or 'Printer').
 It is assumed that model numbers in the Product table are unique
 for all makers and product types.

 Each personal computer in the PC table is unambiguously identified
 by a unique code, and is additionally characterized by its model
 (foreign key referring to the Product table),
 ...
 The Laptop table is similar to the PC table,
 except that instead of the CD-ROM speed,
 ...
 printing technology ('Laser', 'Jet', or 'Matrix') – type,
 and price are specified.
